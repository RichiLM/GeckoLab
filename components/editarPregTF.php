...
if (isset($_SESSION["usuario"]) && $estatusAdmin == 1 && isset($_GET["idTemaTF"]) && isset($_GET["idPregTF"])) {
    $idTema = $_GET["idTemaTF"];
    $idPregunta = $_GET["idPregTF"];

    if (isset($_POST["actPreg"])) {
        $preguntaAct = $_POST["preguntaM"];
        $respuestaCAct = $_POST["respuestaC"];
        $respuestaIAct = $_POST["respuestaI1"];

        $idTema = $_POST["numTema"];
        $idPregunta = $_POST["numPreg"];
        
        $actPreg = "UPDATE pregunta_verd_fal SET pregunta = '$preguntaAct', respuesta_correcta = '$respuestaCAct', respuesta_incorrecta = '$respuestaIAct' WHERE id_pregunta = '$idPregunta' AND id_tema = '$idTema'";
...
?>
    ...
    <body>
        ...
        <div class="container">
            ...
            $traerPregunta = "SELECT * FROM pregunta_verd_fal WHERE id_tema = '$idTema' AND id_pregunta = '$idPregunta'";
            ...
            $respuestaIncorrecta = $fetchPregunta["respuesta_incorrecta"];
            ...
            <h2 class="titulo text-center mt-4 mb-4">Tema <?php echo $nombreTema; ?></h1>
                <form action="" method="post" style="max-width: 600px;" class="mx-auto">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input name="respuestaI1" type="text" class="form-control" placeholder="Respuesta incorrecta 1" aria-label="Username" aria-describedby="basic-addon1" value="<?php echo $respuestaIncorrecta; ?>">
                    </div>
