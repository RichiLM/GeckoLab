...
if (isset($_SESSION["usuario"]) && $estatusAdmin == 1 && isset($_GET["idTM"])) {
    ...
    if (isset($_POST["regPregTF"])) {
        $pregunta = $_POST["preguntaTF"];
        $respuestaC = $_POST["respuestaCorrectaTF"];
        $respuestaI = $_POST["respuestaIncorrectaTF"];
    
        $traerMaxId = "SELECT MAX(id_pregunta) as max_id FROM pregunta_verd_fal";
        ...
        $insertarPreg = "INSERT INTO pregunta_verd_fal VALUES ('$nuevoID', '$idTema', '$pregunta', '$respuestaC', '$respuestaI')";
        $resultInsertTF = mysqli_query($conexion, $insertarPreg);
    }
?>
    <!DOCTYPE html>
    <html lang="es">
    ...
    <body>
        ...
        <div class="container">
            <h1 class="titulo text-center mt-5">Alta de pregunta verdadero/falso</h1>
            <?php
            ...
            <h2 class="titulo text-center mt-4 mb-4">Tema <?php echo $nombreTema; ?></h1>
                <form action="" method="post" style="max-width: 600px;" class="mx-auto">
                    <div class="input-group mb-3">
                        ...
                        <input required name="preguntaTF" type="text" class="form-control" placeholder="Texto de la pregunta" aria-label="Username" aria-describedby="basic-addon1">
                    </div>
                    <div class="input-group mb-3">
                        <span class="input-group-text fw-bold" id="basic-addon1" style="background-color: rgb(18, 168, 255);">Respuesta correcta</span>
                        <input required name="respuestaCorrectaTF" type="text" class="form-control" placeholder="Respuesta correcta" aria-label="Username" aria-describedby="basic-addon1">
                    </div>
                    <div class="input-group mb-3">
                        <span class="input-group-text fw-bold" id="basic-addon1" style="background-color: rgb(18, 168, 255);">Respuesta incorrecta 1</span>
                        <input required name="respuestaIncorrectaTF" type="text" class="form-control" placeholder="Respuesta incorrecta 1" aria-label="Username" aria-describedby="basic-addon1">
                    </div>
                    ...
                    <button type="submit" name="regPregTF" class="btn btn-primary d-block mx-auto my-5" style="max-width: 150px;">Añadir pregunta</button>
                </form>
        </div>
        <!-- Modal -->
